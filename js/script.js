...
const tours = [
  {
    ...
    destinations: [
      {
        ...
        description:
          "Taman Ayun Temple adalah landmark di desa Mengwi, Kabupaten Badung. Kompleks candi ini memiliki arsitektur tradisional yang megah.",
        duration: "1 Jam",
      ...
      },
      {
        name: "Beratan Lake",
        image:
          "https://images.unsplash.com/photo-1588868109521-a4a3a1bcd7c6?w=500&h=350&fit=crop",
        description:
          "Danau Beratan terletak di Bedugul. Ini adalah danau yang sangat indah dengan pura di tengahnya.",
        duration: "1.5 Jam",
    ...
    itineraries: [
      {
        time: "08:00",
        title: "Pick Up di Hotel",
        description:
          "Driver akan menjemput Anda di lobby hotel dengan kendaraan premium.",
      },
      {
        time: "09:00",
        title: "Taman Ayun Temple",
        description: "Mengunjungi candi peninggalan kerajaan Mengwi.",
      },
      {
        time: "11:00",
        title: "Beratan Lake",
        description: "Menikmati keindahan danau Beratan.",
      },
    ],
  },
  {
    ...
    description:
      "Lovina Dolphin Tour offers a memorable sunrise experience where you can watch wild dolphins in their natural habitat while enjoying the peaceful beauty of Lovina Beach.",
    image:
  ...
  },
  {
    ...
    title: "BEDUGUL TOUR",
    description:
      "Jelajahi keindahan pantai Kelingking, Angel Billabong, dan Broken Beach di Nusa Penida.",
    image:
      "https://images.unsplash.com/photo-1588868109521-a4a3a1bcd7c6?w=400&h=300&fit=crop",
    price: "Rp 500.000",
    badge: "Petualangan",
  ...
  },
  {
    ...
    description:
      "Saksikan lumba-lumba liar di pagi hari dan nikmati keindahan pantai Lovina yang tenang.",
    image:
      "https://images.unsplash.com/photo-1537996194471-e657df975ab4?w=400&h=300&fit=crop",
    price: "Rp 420.000",
    badge: "Populer",
...
// Menampilkan halaman tur detail
function renderTourDetail() {
  // Cek apakah berada di halaman tour-detail.html
  ...
  document.getElementById("tourDetailBg").style.backgroundImage =
    `url('${tour.image}')`;
  document.getElementById("tourBreadcrumb").innerText = tour.title;

  // Memisahkan kata pertama agar kata berikutnya berwarna emas
  ...
  document.getElementById("tourPriceMeta").innerHTML =
    `<i class="fas fa-tag"></i> Mulai ${tour.price}`;
  document.getElementById("tourSidebarPrice").innerText = tour.price;

  // Update link tombol wa agar pesannya langsung menyebutkan nama paket
  ...
  if (bookingForm) {
    bookingForm.addEventListener("submit", function (e) {
      ...
      const message =
        `Halo KARI GARAGE, saya ingin booking paket tour berikut:\n\n` +
        `📦 *Paket:* ${tour.title}\n` +
        `👤 *Nama:* ${name}\n` +
        `📅 *Tanggal:* ${date}\n` +
  ...
  if (destContainer) {
    ...
    if (tour.destinations && tour.destinations.length > 0) {
      destContainer.innerHTML = tour.destinations
        .map(
          (dest, index) => `
      ...
      destContainer.innerHTML =
        '<p style="text-align:center; color:#888;">Data destinasi belum tersedia. Segera diupdate!</p>';
    }
  }
  ...
  if (itinContainer) {
    if (tour.itineraries && tour.itineraries.length > 0) {
      itinContainer.innerHTML = tour.itineraries
        .map(
          (itin) => `
      ...
      itinContainer.innerHTML =
        '<p style="text-align:center; color:#888;">Data itinerary belum tersedia. Segera diupdate!</p>';
    }
  }
}
